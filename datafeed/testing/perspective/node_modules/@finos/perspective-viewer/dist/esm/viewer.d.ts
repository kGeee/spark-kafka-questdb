...
export interface IPerspectiveViewerElement {
     ...
     * ```
     */
    notifyResize(force: any): Promise<void>;
    /**
     ...
     * ```
     */
    restore(config: PerspectiveViewerConfig | string | ArrayBuffer): Promise<void>;
    /**
    ...
    save(format?: "json" | "arraybuffer" | "string"): Promise<PerspectiveViewerConfig | string | ArrayBuffer>;
    /**
